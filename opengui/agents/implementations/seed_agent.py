# Vendored from MobileWorld src/mobile_world/agents/implementations/seed_agent.py for OpenGUI profile parity.
...
from opengui.agents.utils.prompts import SEED_PROMPT
