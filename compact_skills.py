...
@skill(app='android', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:android:open_file_in_downloads', name='open_file_in_downloads', description='Open a text file in the Downloads directory and select a viewer application.', created_at=1782833572.4207454, success_count=1)
...
@skill(app='android', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:android:open_image_file', name='open_image_file', description='Open an image file from the Downloads folder using the Gallery app to view its content.', created_at=1782833718.3461401, success_count=1)
...
@skill(app='at.tomtasche.reader', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:at.tomtasche.reader:read_pdf_technical_details', name='read_pdf_technical_details', description='Open a PDF document and scroll through it to locate technical specifications or parameter counts.', created_at=1782842880.9758217, success_count=1)
...
@skill(app='com.android.camera2', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.camera2:take_photo', name='take_photo', description='Opens the camera application and captures a single photo.', created_at=1782844552.1742656, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:add_featured_hashtag', name='add_featured_hashtag', description='Adds a hashtag to the featured hashtags section in Mastodon profile via web UI.', created_at=1782835254.6634638, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:chrome_weather_search', name='chrome_weather_search', description='Search for weather information using Chrome browser', created_at=1782833465.1867452, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:export_mastodon_follows', name='export_mastodon_follows', description='Export follows list from Mastodon account settings via web interface.', created_at=1782838365.463691, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:find_in_page_search', name='find_in_page_search', description="Search for a term within the current webpage using the 'Find in page' feature.", created_at=1782833631.9622438, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:google_search', name='google_search', description='Search for a query using the Google search bar in Chrome', created_at=1782841803.5487185, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:import_muted_list', name='import_muted_list', description='Import a muted accounts list from a CSV file in Mastodon.', created_at=1782838839.929208, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:search_arxiv_paper', name='search_arxiv_paper', description='Search for a academic paper on arXiv using the Chrome browser.', created_at=1782844379.3683915, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:search_github_repo', name='search_github_repo', description='Search for a GitHub repository using Google and navigate to the repository page.', created_at=1782833243.6931186, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:view_document_content', name='view_document_content', description='Open a document in Chrome and scroll to view its content', created_at=1782833592.2417772, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:web_search', name='web_search', description='Perform a web search query in the Chrome browser.', created_at=1782844577.6004558, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:attach_file_and_send', name='attach_file_and_send', description='Attaches a file to the current email draft and sends the email.', created_at=1782844491.4201112, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:check_email_content', name='check_email_content', description='Open the mail application and locate a email by subject to verify its contents.', created_at=1782833086.7276344, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:compose_email', name='compose_email', description='Compose a new email in Gmail with a recipient and subject line.', created_at=1782843243.0559106, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:compose_email_2', name='compose_email_2', description='Open the email application and start composing a new message.', created_at=1782843314.2437236, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:compose_email_3', name='compose_email_3', description='Compose an email with a recipient, subject, and attachment.', created_at=1782843989.641542, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:navigate_to_awaiting_shipment', name='navigate_to_awaiting_shipment', description='Navigate to the awaiting shipment order list within the application', created_at=1782831869.0361888, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:open_email_by_subject', name='open_email_by_subject', description='Open a email in the Gmail clone app by locating it in the inbox.', created_at=1782833147.0409307, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:open_gmail_and_select_email', name='open_gmail_and_select_email', description='Opens the Gmail application and selects an email from the inbox.', created_at=1782844358.5951874, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:open_mail_and_tap_email', name='open_mail_and_tap_email', description='Opens the Gmail application and taps on a email in the inbox.', created_at=1782833385.0996256, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:reply_to_email', name='reply_to_email', description="Reply to a contact's email with a custom message.", created_at=1782831575.7811081, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:reply_to_email_2', name='reply_to_email_2', description="Reply to a contact's email with a custom message", created_at=1782831745.1145709, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:reply_to_email_3', name='reply_to_email_3', description='Open Gmail, reply to an email, compose a message, and initiate file attachment.', created_at=1782844461.9003425, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:search_email', name='search_email', description='Search for an email by keyword and open the matching message.', created_at=1782832953.7630267, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:send_email', name='send_email', description='Compose and send an email in Gmail to a recipient with a subject.', created_at=1782842404.6995952, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:send_email_2', name='send_email_2', description='Compose and send an email with attachments.', created_at=1782843930.9082572, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:send_email_with_attachment', name='send_email_with_attachment', description='In com.gmailclone, attaches a file to an email and sends it.', created_at=1782834294.479449, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:send_email_with_attachment_2', name='send_email_with_attachment_2', description='Send an email with an attachment in Gmail.', created_at=1782844110.9602046, success_count=1)
...
@skill(app='com.google.android.apps.messaging', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.messaging:reply_to_message', name='reply_to_message', description='Reply to a message in the Google Messages app.', created_at=1782843082.648559, success_count=1)
...
@skill(app='com.google.android.apps.messaging', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.messaging:reply_to_message_2', name='reply_to_message_2', description='Opens the messaging app, selects a conversation, dismisses any save-contact popup, and sends a reply message.', created_at=1782843130.312011, success_count=1)
...
@skill(app='com.google.android.apps.wallpaper', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.wallpaper:apply_wallpaper', name='apply_wallpaper', description='Apply a selected wallpaper to the device screens.', created_at=1782832648.6201546, success_count=1)
...
@skill(app='com.google.android.apps.wallpaper', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.wallpaper:navigate_to_wallpaper_selection', name='navigate_to_wallpaper_selection', description='Open the wallpaper settings app and navigate to the wallpaper selection screen.', created_at=1782832585.035508, success_count=1)
...
@skill(app='com.google.android.deskclock', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.deskclock:set_alarm', name='set_alarm', description='Sets a new alarm at a specified time.', created_at=1782833194.383293, success_count=1)
...
@skill(app='com.google.android.dialer', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.dialer:find_contact_in_phone_app', name='find_contact_in_phone_app', description='Opens the phone application, navigates to the contacts tab, and scrolls to locate a contact.', created_at=1782838714.3730042, success_count=1)
...
@skill(app='com.google.android.documentsui', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.documentsui:extract_archive_contents', name='extract_archive_contents', description='Extracts the contents of a selected archive to the current directory.', created_at=1782833539.846864, success_count=1)
...
@skill(app='com.google.android.documentsui', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.documentsui:open_file_in_zip', name='open_file_in_zip', description='Open a file located inside a ZIP archive within the Downloads directory.', created_at=1782833501.0489907, success_count=1)
...
@skill(app='com.google.android.documentsui', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.documentsui:rename_file', name='rename_file', description='Rename a file in the Documents/Files app', created_at=1782838420.2359502, success_count=1)
...
@skill(app='com.google.android.documentsui', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.documentsui:save_file_to_directory', name='save_file_to_directory', description='Save a file to a specified directory within the Documents app.', created_at=1782844427.874688, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:copy_message_text', name='copy_message_text', description='Copies the text content of a message within a Mattermost channel.', created_at=1782840620.4638374, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:navigate_to_mattermost_channel', name='navigate_to_mattermost_channel', description='Navigate to a channel in Mattermost to view messages.', created_at=1782842205.7392704, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:open_direct_message', name='open_direct_message', description='Opens a direct message conversation with a contact in Mattermost.', created_at=1782842358.8962023, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:send_message', name='send_message', description='Sends a text message in Mattermost.', created_at=1782842419.5045989, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:awaiting_shipment_orders', name='awaiting_shipment_orders', description='Navigate to the awaiting shipment orders section in the TaoDian app.', created_at=1782832417.7471998, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:confirm_delete_selection', name='confirm_delete_selection', description='Confirms the deletion of selected items in a shopping cart and verifies the updated list.', created_at=1782832546.642198, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:filter_orders_by_period', name='filter_orders_by_period', description='Filter order list by time period', created_at=1782842961.676514, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:find_awaiting_shipment_orders', name='find_awaiting_shipment_orders', description='Navigate to the awaiting shipment orders section in the TaoDian app.', created_at=1782831840.448404, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:locate_order_item', name='locate_order_item', description='Navigate to the order list and locate the target product order item.', created_at=1782839004.4070506, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:open_app_and_dismiss_popup', name='open_app_and_dismiss_popup', description='Open the app and dismiss the promotional cash popup.', created_at=1782842895.743952, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:open_app_dismiss_popup', name='open_app_dismiss_popup', description='Opens the TaoDian app and dismisses the initial promotional popup.', created_at=1782832682.4496725, success_count=1)
...
@skill(app='gallery.photomanager.picturegalleryapp.imagegallery', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:gallery.photomanager.picturegalleryapp.imagegallery:create_new_folder', name='create_new_folder', description="Create a new folder within the gallery app's move dialog.", created_at=1782842771.1959045, success_count=1)
...
@skill(app='gallery.photomanager.picturegalleryapp.imagegallery', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:gallery.photomanager.picturegalleryapp.imagegallery:finalize_photo_organization', name='finalize_photo_organization', description='Finalizes photo organization by confirming permissions and returning to the main gallery view.', created_at=1782842811.4575891, success_count=1)
...
@skill(app='gallery.photomanager.picturegalleryapp.imagegallery', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:gallery.photomanager.picturegalleryapp.imagegallery:move_photos_to_new_folder', name='move_photos_to_new_folder', description='Move selected photos to a newly created folder in the gallery app.', created_at=1782842713.4414334, success_count=1)
...
@skill(app='gallery.photomanager.picturegalleryapp.imagegallery', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:gallery.photomanager.picturegalleryapp.imagegallery:open_gallery_and_select_album', name='open_gallery_and_select_album', description='Opens the picture and wallpaper application and navigates to a album within the photo picker.', created_at=1782832620.1393328, success_count=1)
...
@skill(app='mcurrentfocus-window-84609a8-u0-media-viewer', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:mcurrentfocus-window-84609a8-u0-media-viewer:save_image_from_mastodon_post', name='save_image_from_mastodon_post', description='Save an image from a Mastodon post by opening it in the media viewer and downloading it.', created_at=1782842078.313857, success_count=1)
...
@skill(app='mcurrentfocus-window-e9c5824-u0-popupwindow-a7c530c', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:mcurrentfocus-window-e9c5824-u0-popupwindow-a7c530c:bookmark_mastodon_post', name='bookmark_mastodon_post', description='Bookmark a post in Mastodon by accessing the post options menu.', created_at=1782834496.4010837, success_count=1)
...
@skill(app='mcurrentfocus-window-f9f9001-u0-media-viewer', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:mcurrentfocus-window-f9f9001-u0-media-viewer:save_image_from_media_viewer', name='save_image_from_media_viewer', description='Taps an image preview to view it full-screen and then taps the download button to save the image.', created_at=1782842008.9041035, success_count=1)
...
@skill(app='org.fossify.calendar', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.fossify.calendar:check_calendar_date', name='check_calendar_date', description='Open the calendar app and navigate to a date to view scheduled events.', created_at=1782842540.5307298, success_count=1)
...
@skill(app='org.fossify.calendar', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.fossify.calendar:check_calendar_events', name='check_calendar_events', description='Opens the calendar app and allows viewing events on dates to retrieve scheduling information.', created_at=1782832920.0464797, success_count=1)
...
@skill(app='org.fossify.calendar', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.fossify.calendar:open_calendar_and_view_date', name='open_calendar_and_view_date', description='Opens the Fossify Calendar app and navigates to a date to view scheduled events.', created_at=1782832827.4029808, success_count=1)
...
@skill(app='org.fossify.calendar', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.fossify.calendar:view_calendar_events', name='view_calendar_events', description='Opens the Fossify Calendar app and displays the schedule for a specified date.', created_at=1782833058.1283252, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:compose_post', name='compose_post', description='Compose a new post by entering text content', created_at=1782839024.1542847, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:create_list', name='create_list', description='Creates a new Mastodon list with a specified name.', created_at=1782837636.6514227, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:create_mastodon_list', name='create_mastodon_list', description='Navigate to list management and initiate list creation by entering a name.', created_at=1782839980.7252452, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:navigate_to_orders', name='navigate_to_orders', description='Navigate to the orders section within the application to review transaction history.', created_at=1782842927.6394837, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:navigate_to_profile', name='navigate_to_profile', description="Open the Mastodon app and navigate to the user's profile page.", created_at=1782835984.552357, success_count=1)
async def navigate_to_profile(device):
    await action('open_app', target='org.joinmastodon.android.mastodon', valid_state='No need to verify', fixed=True, fixed_values={'text': 'org.joinmastodon.android.mastodon'})
    await action('tap', target='Profile tab', valid_state='Profile tab is visible and clickable', fixed=True, fixed_values={'x': 945, 'y': 2220})


@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:navigate_to_user_profile', name='navigate_to_user_profile', description="Navigate to a user's profile in Mastodon by searching for their username.", created_at=1782834468.0473247, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:open_post_from_feed', name='open_post_from_feed', description='Open a post from a hashtag feed to view details.', created_at=1782837476.1302314, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:open_post_in_hashtag_feed', name='open_post_in_hashtag_feed', description='Opens a post in the Mastodon app by searching for a hashtag and scrolling to the post.', created_at=1782837395.786865, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:post_mastodon_message', name='post_mastodon_message', description='Compose and input text into a new Mastodon post.', created_at=1782840629.9388468, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:post_toot', name='post_toot', description='Compose and publish a new toot in the Mastodon app', created_at=1782841180.6890452, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:process_bookmarked_post', name='process_bookmarked_post', description='Removes a bookmark from a post, adds it to favorites, and boosts it.', created_at=1782835928.5469668, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:publish_post_with_image', name='publish_post_with_image', description='Publish a post with attached image on Mastodon.', created_at=1782839129.4382515, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:scroll_profile_timeline', name='scroll_profile_timeline', description="Scroll through a user's timeline to view posts.", created_at=1782834649.7185662, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:search_hashtag_feed', name='search_hashtag_feed', description='Search for a hashtag on Mastodon and navigate to the corresponding posts feed.', created_at=1782837221.9795332, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:search_user_and_open_post', name='search_user_and_open_post', description='Search for a user by name, navigate to their profile, and open a post identified by a description.', created_at=1782841973.1754704, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:set_brightness_minimum', name='set_brightness_minimum', description='Set the display brightness to the minimum level.', created_at=1782831613.188358, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:view_announcements_channel', name='view_announcements_channel', description='Navigate to and view the announcements channel in the Mastodon mobile application.', created_at=1782840594.376483, success_count=1)
