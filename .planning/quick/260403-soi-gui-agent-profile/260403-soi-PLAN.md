...
- action: Add a formal `GuiConfig.agent_profile` field, validate it through the shared GUIClaw profile canonicalization seam, and remove runtime `getattr(...)` fallbacks in nanobot GUI wiring.
...
### Task 2
- files: `tests/test_guiclaw_p3_nanobot.py`, `tests/test_gui_skill_executor_wiring.py`
...
### Task 3
- files: `guiclaw/README.md`, `guiclaw/README_CN.md`, `.planning/STATE.md`, `.planning/quick/260403-soi-gui-agent-profile/260403-soi-SUMMARY.md`
