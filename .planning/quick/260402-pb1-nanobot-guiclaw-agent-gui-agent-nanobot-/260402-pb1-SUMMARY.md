...
tags: [gui, model-routing, provider-resolution, evaluation, nanobot, guiclaw]
dependency_graph:
  requires: []
...
- `uv run pytest tests/cli/test_commands.py::test_make_provider_honors_gui_model_and_provider_override tests/test_guiclaw_p3_nanobot.py::test_agent_loop_registers_gui_tool_with_gui_runtime_override tests/test_guiclaw_p6_wiring.py::test_gui_config_accepts_model_provider_and_evaluation_aliases tests/test_guiclaw_p8_trajectory.py::test_gui_evaluation_runs_from_background_postprocessing tests/test_guiclaw_p8_trajectory.py::test_gui_evaluation_failure_is_non_fatal -q`
