...
>>>>>>> 3f58584f (docs(20-03): add web workspace smoke guidance)
...
The browser workspace is local-first and optional. It is hosted by the gateway's
embedded WebSocket `/webui` surface; standalone TUI packaging has been removed.
See [WebUI Document](./webui/README.md) for source-checkout development docs and
build steps.
