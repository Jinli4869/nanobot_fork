...
@skill(app='com.android.camera2', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.camera2:take_photo', name='take_photo', description='Opens the camera application and captures a photo by tapping the shutter button.', created_at=1780854017.3433895, success_count=1)
...
@skill(app='com.android.camera2', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.camera2:take_photo_2', name='take_photo_2', description='Opens the camera app and captures a photo.', created_at=1780854052.2194104, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:import_muted_list', name='import_muted_list', description='Navigates to the Mastodon web import settings and selects the muted list type.', created_at=1780851029.2665827, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:navigate_to_url', name='navigate_to_url', description='Navigate to a web address in Chrome', created_at=1780853850.7577283, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:search_in_chrome', name='search_in_chrome', description='Search for a query in the Chrome browser.', created_at=1780852592.835042, success_count=1)
...
@skill(app='com.android.chrome', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.android.chrome:search_in_chrome_2', name='search_in_chrome_2', description='Search for a query in the Chrome browser.', created_at=1780853790.1176612, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:compose_and_send_email', name='compose_and_send_email', description='Compose and send an email to a recipient with a message', created_at=1780853759.6093013, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:confirm_attachment_and_send', name='confirm_attachment_and_send', description='Select an attachment file, send the email, and verify it appears in the Sent folder.', created_at=1780854006.3857265, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:open_email_and_report', name='open_email_and_report', description='Open the email application, tap on an email from a sender, and report the extracted information.', created_at=1780849006.0342226, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:open_email_by_subject', name='open_email_by_subject', description='Open the email application and locate a email by scrolling through the inbox.', created_at=1780848696.7805905, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:read_email', name='read_email', description='Opens the Gmail application and reads the content of a email identified by its subject.', created_at=1780853176.3490634, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:reply_email_with_attachment', name='reply_email_with_attachment', description='Reply to an email with text content and initiate file attachment.', created_at=1780853939.137708, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:reply_to_email', name='reply_to_email', description='Reply to an email by locating it via subject, typing a message, and sending it.', created_at=1780848296.69664, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:reply_to_email_2', name='reply_to_email_2', description='Open the mail app, locate an email by subject, reply to it with a message, and send it.', created_at=1780848325.2102857, success_count=1)
...
@skill(app='com.gmailclone', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.gmailclone:scroll_inbox', name='scroll_inbox', description='Open the mail application and scroll through the inbox to locate a message.', created_at=1780853245.1945376, success_count=1)
...
@skill(app='com.google.android.apps.messaging', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.messaging:send_sms', name='send_sms', description='Send an SMS message to a specified recipient with custom content.', created_at=1780848368.361123, success_count=1)
...
@skill(app='com.google.android.apps.messaging', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.messaging:send_sms_2', name='send_sms_2', description='Send an SMS message to a specified recipient.', created_at=1780853461.3118608, success_count=1)
...
@skill(app='com.google.android.apps.messaging', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.messaging:send_sms_3', name='send_sms_3', description='Send an SMS message to a specified recipient with a given text content.', created_at=1780854114.5302026, success_count=1)
...
@skill(app='com.google.android.apps.messaging', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.apps.messaging:send_sms_message', name='send_sms_message', description='Send an SMS message to a contact by entering their phone number and typing the message content.', created_at=1780853217.0481167, success_count=1)
...
@skill(app='com.google.android.deskclock', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.deskclock:set_alarm', name='set_alarm', description='Opens the Clock app, navigates to the Alarm tab, and sets a new alarm to the specified time.', created_at=1780848754.7974992, success_count=1)
...
@skill(app='com.google.android.dialer', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.dialer:navigate_to_contacts', name='navigate_to_contacts', description='Opens the phone application, navigates to the contacts section, and scrolls through the contact list to locate an entry.', created_at=1780837473.2451031, success_count=1)
...
@skill(app='com.google.android.documentsui', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.documentsui:navigate_to_folder', name='navigate_to_folder', description='Navigate to a folder in the Android file picker.', created_at=1780853550.8622124, success_count=1)
...
@skill(app='com.google.android.documentsui', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.documentsui:save_file_to_downloads', name='save_file_to_downloads', description='Saves a file to the Downloads folder with a specified filename.', created_at=1780853882.8548908, success_count=1)
...
@skill(app='com.google.android.providers.media.module', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.providers.media.module:open_media_picker_and_scroll', name='open_media_picker_and_scroll', description='Opens the system media picker application and scrolls through the recent photos to locate an image.', created_at=1780853522.3538644, success_count=1)
...
@skill(app='com.google.android.providers.media.module', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.google.android.providers.media.module:select_image_from_gallery', name='select_image_from_gallery', description="Selects a image from the device's photo gallery to attach to a message.", created_at=1780852963.4671786, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:confirm_and_send_message', name='confirm_and_send_message', description='Confirm an attached media item and send the message in Mattermost.', created_at=1780853010.8657358, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:copy_message_in_channel', name='copy_message_in_channel', description='Locate a message in a Mattermost channel and copy its text content.', created_at=1780851947.9870255, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:create_private_channel', name='create_private_channel', description='Create a new private channel with a specified name.', created_at=1780850007.445288, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:post_message_in_channel', name='post_message_in_channel', description='Opens Mattermost, navigates to a channel, and posts a message.', created_at=1780852860.31884, success_count=1)
...
@skill(app='com.mattermost.rnbeta', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.mattermost.rnbeta:start_direct_message', name='start_direct_message', description='In Mattermost, initiate a private direct message conversation with a user.', created_at=1780852923.0795321, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:confirm_deletion_and_scroll', name='confirm_deletion_and_scroll', description='Confirms item deletion in the shopping cart and scrolls through the list to verify removal.', created_at=1780848538.8478634, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:extract_awaiting_shipment_order_details', name='extract_awaiting_shipment_order_details', description='Extracts product names, order numbers, and recipient information from items awaiting shipment in the TaoDian app.', created_at=1780848338.9648197, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:login_via_sms', name='login_via_sms', description='Opens the app, navigates to the cart to trigger login, and switches to SMS login mode.', created_at=1780849149.4194784, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:navigate_to_cart', name='navigate_to_cart', description='Open the application and navigate to the shopping cart section.', created_at=1780848400.2683132, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:navigate_to_orders', name='navigate_to_orders', description='Navigate to the order history page in the shopping application to view past purchases.', created_at=1780848917.1688774, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:sms_login', name='sms_login', description='Log in to the app using SMS verification code.', created_at=1780848423.008302, success_count=1)
...
@skill(app='com.testmall.app', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:com.testmall.app:view_shopping_cart', name='view_shopping_cart', description='Navigate to the shopping cart and scroll through the item list to view products.', created_at=1780848671.1741035, success_count=1)
...
@skill(app='mcurrentfocus-window-5ccb194-u0-media-viewer', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:mcurrentfocus-window-5ccb194-u0-media-viewer:favorite_post', name='favorite_post', description='Favorites a post in the Mastodon application.', created_at=1780849940.0790048, success_count=1)
...
@skill(app='org.fossify.calendar', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.fossify.calendar:open_calendar_app', name='open_calendar_app', description='Open the Fossify Calendar app and navigate to the month view.', created_at=1780853081.9951274, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:bookmark_post', name='bookmark_post', description='Bookmark posts with hashtags on a Mastodon user profile.', created_at=1780846972.2818851, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:compose_post', name='compose_post', description='Compose a new post with specified content in Mastodon.', created_at=1780851976.2326794, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:create_list', name='create_list', description='Create a new Mastodon list with a specified name.', created_at=1780850134.3166232, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:create_mastodon_list', name='create_mastodon_list', description='Create a new Mastodon list with a specified name.', created_at=1780851807.7552426, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:edit_profile_header', name='edit_profile_header', description='Navigate to the profile page and open the profile editing interface to change the header image.', created_at=1780849828.6090121, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:favorite_hashtag_posts', name='favorite_hashtag_posts', description='Favorites posts containing a hashtag in Mastodon.', created_at=1780849908.8415606, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:favorite_hashtag_posts_2', name='favorite_hashtag_posts_2', description='Favorites posts associated with a hashtag in Mastodon by scrolling through the feed and tapping the favorite button.', created_at=1780849981.5180173, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:navigate_to_mastodon_profile_and_explore', name='navigate_to_mastodon_profile_and_explore', description='Open the Mastodon app and navigate to the Profile and Explore sections to locate the Lists feature.', created_at=1780850055.410962, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:open_mastodon_and_retry', name='open_mastodon_and_retry', description='Open the Mastodon application and handle connection errors by retrying.', created_at=1780852811.7180996, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:open_settings', name='open_settings', description='Opens the Mastodon application and navigates to the main settings menu.', created_at=1780850911.3418238, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:post_toot', name='post_toot', description='Post a new message to Mastodon.', created_at=1780852557.5885491, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:search_and_favorite_tag', name='search_and_favorite_tag', description='Search for a hashtag in Mastodon and favorite the first post.', created_at=1780850854.5103655, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:search_hashtag', name='search_hashtag', description='Search Mastodon for a hashtag and browse the posts feed.', created_at=1780850243.2645533, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:search_mastodon_posts', name='search_mastodon_posts', description='Search Mastodon for posts using a query.', created_at=1780850217.596991, success_count=1)
...
@skill(app='org.joinmastodon.android.mastodon', platform='android', tags=['compact', 'compact_extracted'], skill_id='compact:org.joinmastodon.android.mastodon:update_profile_header', name='update_profile_header', description='Update the Mastodon profile header image.', created_at=1780849879.8917508, success_count=1)
