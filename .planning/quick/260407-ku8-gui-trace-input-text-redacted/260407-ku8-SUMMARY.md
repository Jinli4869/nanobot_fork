...
- Updated [`guiclaw/agent.py`](/Users/jinli/Documents/Personal/nanobot_fork/guiclaw/agent.py) to split artifact scrubbing from log scrubbing:
...
- Updated [`tests/test_guiclaw_p15_intervention.py`](/Users/jinli/Documents/Personal/nanobot_fork/tests/test_guiclaw_p15_intervention.py) to verify typed text is preserved in trace artifacts.

## Verification

- `uv run pytest tests/test_guiclaw_p15_intervention.py -q`
