# Vendored from MobileWorld src/mobile_world/agents/implementations/qwen3vl.py for OpenGUI profile parity.
...
from opengui.agents.utils.agent_mapping import QWENVL2AW_ACTION_MAP
