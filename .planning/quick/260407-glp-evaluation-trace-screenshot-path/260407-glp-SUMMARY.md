...
- Added regression coverage in [`tests/test_guiclaw_p8_trajectory.py`](/Users/jinli/Documents/Personal/nanobot_fork/tests/test_guiclaw_p8_trajectory.py) proving evaluation can load screenshots from `screenshot_path`.
